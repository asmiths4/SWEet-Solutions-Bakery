	...
	public class myController {
	    ...
	    public void sendInformation() throws IOException {
	    	...
	    	if(available) {
	    	  ...
	    	  MyMain.changeToPage((Stage) submitButton.getParent().getScene().getWindow(),"/customOrders/ConfirmationPage.fxml");
	    	}
	    	else {
	    ...
	    public void changeInformation() throws IOException{
            ...
            MyMain.changeToPage(st, "/customOrders/sweetSolutionsCustomOrders.fxml");
	    	return;
	    }
